<script lang="ts">
	...
	const isLocked = $derived(education.lockedForReviewAt !== undefined);
</script>

<div class="border-l-4 {isLocked ? 'border-orange-500 bg-orange-50' : 'border-green-500'} pl-4 py-4 bg-white rounded-r-lg border border-gray-200 hover:shadow-sm transition-shadow">
