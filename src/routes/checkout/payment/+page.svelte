							...
							<div class="space-y-4">
								...
								<div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
									...
									<div class="space-y-2 text-sm">
										...
										<div class="flex justify-between">
											...
											<span class="font-bold text-gray-900">€{storeState.totalAmount.toFixed(2)}</span>
										</div>
									</div>
								</div>
								...
								<div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
									...
									<ul class="text-sm text-blue-700 space-y-1">
										...
										<li>• Transfer the exact amount: <strong>€{storeState.totalAmount.toFixed(2)}</strong></li>
								...
								<div>
									...
									<input
										...
										class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
									/>
									<p class="text-xs text-gray-500 mt-1">Upload screenshot or PDF of your bank transfer confirmation</p>
								</div>
							</div>
						{/if}
					</div>
						...
						<div class="bg-red-50 border border-red-200 rounded-lg p-4">
							<div class="flex items-center">
								<svg class="w-5 h-5 text-red-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
									<path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L10 10.586l2.707-2.707a1 1 0 001.414 1.414L11.414 12l2.707 2.707a1 1 0 01-1.414 1.414L10 13.414l-2.707 2.707a1 1 0 01-1.414-1.414L8.586 12 5.879 9.293a1 1 0 011.414-1.414L10 10.586z" clip-rule="evenodd"/>
								</svg>
					...
					<div class="space-y-3">
						...
						>
							{isLoading ? 'Processing Payment...' : 
							 paymentMethod === 'credit_card' ? 'Pay Now' : 'Confirm Bank Transfer'}
						</button>
