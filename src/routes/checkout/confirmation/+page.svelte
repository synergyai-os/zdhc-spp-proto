<script lang="ts">
	...
	let paymentReference = $derived(
		storeState.paymentDetails.bankReference || `CC-${Date.now().toString().slice(-6)}`
	);
</script>
...
<div class="bg-gray-50 min-h-screen py-8">
	<div class="max-w-4xl mx-auto px-6">
		...
		<div class="text-center mb-8">
			<div
				class="mx-auto flex items-center justify-center h-16 w-16 rounded-full {isSuccessful
					? 'bg-green-100'
					: 'bg-yellow-100'} mb-4"
			>
				{#if isSuccessful}
					...
					<div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
						...
						<div class="space-y-3">
							...
							<div class="flex justify-between">
								...
								<span
									class="text-sm font-medium {isSuccessful ? 'text-green-600' : 'text-yellow-600'}"
								>
								...
								<div class="border border-gray-200 rounded-lg p-4">
									<div class="flex items-center justify-between mb-3">
										<div class="flex items-center space-x-3">
											<div
												class="w-8 h-8 bg-blue-500 text-white rounded-full flex items-center justify-center font-semibold text-xs"
											>
										...
										<div class="flex items-center space-x-2">
											<span
												class="px-2 py-1 text-xs rounded-full {isSuccessful
												...
												<div class="flex items-center justify-between p-2 bg-gray-50 rounded-lg">
													<div class="flex items-center space-x-2">
														...
														{#if assignment.role === 'lead'}
															<span
																class="px-1.5 py-0.5 text-xs rounded-full bg-yellow-200 text-yellow-800 font-semibold"
															>
																LEAD
															</span>
														{/if}
					...
					<div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
						...
						{#if isSuccessful}
							...
							<div class="space-y-3 text-sm text-gray-600">
								<div class="flex items-start space-x-3">
									<div
										class="flex-shrink-0 w-6 h-6 bg-green-100 text-green-600 rounded-full flex items-center justify-center text-xs font-semibold"
									>
										1
									</div>
									<p>
										<strong>Payment Confirmed:</strong> Your payment has been processed and expert statuses
										updated to "paid".
									</p>
								</div>
								<div class="flex items-start space-x-3">
									...
									<p>
										<strong>Training Invitation:</strong> Experts will be invited to complete their training
										within 24-48 hours.
									</p>
								</div>
								<div class="flex items-start space-x-3">
									...
									<p>
										<strong>Certification:</strong> After training completion, experts will be certified
						...
						{:else}
							...
							<div class="space-y-3 text-sm text-gray-600">
								<div class="flex items-start space-x-3">
									<div
										class="flex-shrink-0 w-6 h-6 bg-yellow-100 text-yellow-600 rounded-full flex items-center justify-center text-xs font-semibold"
									>
										1
									</div>
									<p>
										<strong>Transfer Submitted:</strong> Your bank transfer has been submitted with
								...
								<div class="flex items-start space-x-3">
									...
									<p>
										<strong>Bank Processing:</strong> We'll confirm receipt of your payment within 1-3
										business days.
									</p>
								</div>
								<div class="flex items-start space-x-3">
									...
									<p>
										<strong>Status Update:</strong> Expert statuses will be updated to "paid" once payment
										is confirmed.
									</p>
								</div>
								<div class="flex items-start space-x-3">
									...
									<p>
										<strong>Training Invitation:</strong> Training invitations will be sent after payment
										confirmation.
									</p>
								</div>
							</div>
