...
<div class="bg-gray-50 min-h-screen py-8">
	<div class="max-w-4xl mx-auto px-6">
		...
		<div class="text-center mb-8">
			...
			{#if expertName}
				<p class="text-lg text-gray-600">Expert "{expertName}" has been added to your organization</p>
			{:else}
		...
		<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
			...
			<!-- Add Another Expert -->
			<button type="button" onclick={goToAddExpert} class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow text-left w-full">
			...
			>
				<div class="text-center">
					<div class="mx-auto flex items-center justify-center h-12 w-12 rounded-full {
						draftCount > 0 ? 'bg-green-100' : 'bg-gray-100'
					} mb-4">
						<svg class="h-6 w-6 {
							draftCount > 0 ? 'text-green-600' : 'text-gray-400'
			...
			<!-- Back to Dashboard -->
			<button type="button" onclick={goToUserManagement} class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow text-left w-full">
				<div class="text-center">
